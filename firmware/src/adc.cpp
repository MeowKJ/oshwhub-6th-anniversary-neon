...
//分压电阻比例
uint8_t voltageDividerRatio1 = 11;
uint8_t voltageDividerRatio2 = 11;
...
void ADC_getVoltages(float* adc1_voltage, float* adc2_voltage) {
    ...
    // 换算为伏特
    *adc1_voltage = adc1_filt_mv / 1000.0f * voltageDividerRatio1;
    *adc2_voltage = adc2_filt_mv / 1000.0f  * voltageDividerRatio2;
}
